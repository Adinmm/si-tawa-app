                          ...
                          <div className="w-[426px]">
                            <div className="flex justify-between items-center">
                              ...
                              <div className=" flex gap-2 text-[10px]">
                                ...
                                <p
                                  className={`status  ${
                                    state.dataReplies.map((data) => data.complaint_id.toString()).includes(item.id.toString())
                                      ? "text-[#06D001]"
                                      : "text-[#E5D206]"
                                  }`}
                                >
                                  {state.dataReplies.map((data) => data.complaint_id.toString()).includes(item.id.toString()) ? "Selesai" : "Diproses"}
                                </p>
                              </div>
                            </div>
                            <div className="flex  ">
